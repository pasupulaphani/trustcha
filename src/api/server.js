...
const projects = [
    ...
    {id: 5, name: 'Fishing project', description: '', funds: '£10,000', icon: 'star', lat: 51.533, lng: -0.087},
    {id: 5, name: 'Farming project', description: '', funds: '£20,000', icon: 'star', lat: 51.533, lng: -0.087}
];
